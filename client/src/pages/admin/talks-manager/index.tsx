...
import { Mic, ListMusic, Disc, ArrowLeft, Activity } from "lucide-react";
import TalksManager from "./TalksManager";
import { Link, Switch, Route, useLocation } from "wouter";

export default function TalksManagerPage() {
  const [location, setLocation] = useLocation();

  useEffect(() => {
    // Redirect base path to talks
    if (location === "/admin/talks-manager" || location === "/admin/talks-manager/") {
      setLocation("/admin/talks-manager/talks");
    }
  ...
  return (
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 md:px-8">
          ...
          <div className="flex justify-between items-center mb-2">
            <div>
              ...
              <p className="font-gp-serif text-[color:var(--gp-white)]/85 mt-2 text-base">
                Manage your radio station&apos;s talks, speeches, and audio content
              </p>
            </div>
            <Button
              variant="outline"
        ...
        <div className="space-y-6">
          ...
          <div>
            <Switch>
              <Route path="/admin/talks-manager/talks">
                <TalksManager />
              </Route>
              {/* fallback to talks when no path matches */}
